...
Check if this script is located in the current workspace or in `$HOME/.agent/skills/markdown-novel-viewer` directory:
- If in current workspace: `$SKILL_DIR_PATH` = `./.agent/skills/markdown-novel-viewer/`
- If in home directory: `$SKILL_DIR_PATH` = `$HOME/.agent/skills/markdown-novel-viewer/`
...
```json
{
  "command": "node .agent/skills/markdown-novel-viewer/scripts/server.cjs --dir \"path\" --host 0.0.0.0 --open --foreground",
